...
url = 'https://www.facebook.com/groups/2325487530867004/?ref=share&mibextid=NSMWBT'
driver.get(url)
...
def scrape_facebook_posts(driver):
    ...
    for _ in range(30):  # Adjust the number of times as needed
...
df.to_csv("facebook_posts_06.csv", index=False, encoding='utf-8-sig')
